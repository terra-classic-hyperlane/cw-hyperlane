...
// ==============================
// NETWORK — MAINNET (columbus-5) — v2 re-deploy with domainId 132556
// Previous deploy used domainId 1325 (conflicted with testnet).
// ==============================
...
async function main() {
  ...
  console.log("\n" + "=".repeat(80));
  console.log("HYPERLANE MAINNET INSTANTIATION v2 — columbus-5 — domain 132556");
  ...
  // ----------------------------------------------------------------
  // 1. MAILBOX
  //    domain: 132556 (Terra Classic mainnet — unique, replaces 1325)
